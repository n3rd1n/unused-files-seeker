...
export class ImportParser {
  ...
  private isBuiltInModule(moduleName: string): boolean {
    const builtInModules = [
      'fs', 'path', 'os', 'util', 'crypto', 'stream', 'events', 'buffer',
      'url', 'querystring', 'http', 'https', 'net', 'tls', 'dns', 'child_process',
      'cluster', 'worker_threads', 'readline', 'repl', 'vm', 'v8', 'perf_hooks',
      'async_hooks', 'timers', 'tty', 'string_decoder', 'assert', 'console',
      'process', 'globals', 'module', 'punycode', 'zlib', 'http2', 'inspector',
      'trace_events', 'wasi', 'worker_threads'
    ];
